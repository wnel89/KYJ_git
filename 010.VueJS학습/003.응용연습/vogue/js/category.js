...
window.addEventListener("DOMContentLoaded", () => {
    ...
    $(".VueGnb a").click(function(e){
        ...
        // pm값이 vuejs 인스턴스 안에 catName 변수로 세팅되어 있지만 이 값을 업데이트 해도 페이지가 업데이트 되지 않는다.
        // 왜? 이것은 vuejs의 변수가 아니기 때문이다!!!!
        
        // vuejs의 대표특징인 양방향바인딩 즉, vuejs를 업데이트하면 화면이 업데이트되는 기능
        // vuejs의 데이터인 catName을 업데이트 하면 된다!!!

        // vuejs의 변수 접근법:
        // vuejs 인스턴스를 변수에 담는다! - db로 담았음
        // 변수.$data.변수면 = 값;
        db.$data.catName = txt;
